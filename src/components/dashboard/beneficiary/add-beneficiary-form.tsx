...
export function AddBeneficiaryForm(): React.JSX.Element {
  ...
  return (
    <Stack spacing={3}>
      <Stack spacing={1}>
        <Typography variant="h4">Add New Beneficiary</Typography>
      </Stack>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Controller
          ...
          <Controller
            ...
            name="CNIC"
            render={({ field }) => (
              <FormControl error={Boolean(errors.CNIC)}>
...
<Controller
          ...
          <Controller
            ...
            name="Area"
            render={({ field }) => (
              <FormControl error={Boolean(errors.Area)}>
          ...
          <Controller
            ...
            name="familyInfo.son"
            render={({ field }) => (
              <FormControl error={Boolean(errors.familyInfo?.son)}>
          ...
          <Controller
            ...
            render={({ field }) => (
              <FormControl error={Boolean(errors.familyInfo?.daughter)}>
          ...
          <Controller
            ...
            render={({ field }) => (
              <FormControl error={Boolean(errors.familyInfo?.adopted)}>
          ...
          <Controller
            ...
            name="profession"
            render={({ field }) => (
              <FormControl error={Boolean(errors.profession)}>
          ...
          <Controller
            ...
            name="modeOfPayment"
            render={({ field }) => (
              <FormControl error={Boolean(errors?.modeOfPayment)}>
          ...
          <Controller
            ...
            name="bank"
            render={({ field }) => (
              <FormControl error={Boolean(errors.bank)}>
          ...
          <Controller
            ...
            name="accountNumber"
            render={({ field }) => (
              <FormControl error={Boolean(errors.accountNumber)}>
